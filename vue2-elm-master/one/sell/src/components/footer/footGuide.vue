<template>
  <section id="foot_guide">
    <section @click="gotoAddress({path: '/msite',query: {geohash}}, $event)"><span>外卖</span></section>
    <section @click="gotoAddress({path: '/search/'+geohash}, $event)"><span>搜索</span></section>
    <section @click="gotoAddress('/order', $event)"><span>订单</span></section>
    <section @click="gotoAddress('/profile', $event)"><span>我的</span></section>
  </section>
</template>
